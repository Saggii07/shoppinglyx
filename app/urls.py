...
from .forms import ChangePassword, LoginForm, MyPasswordResetForm,MyPasswordSetForm
urlpatterns = [
    ...
    path('passwordchange/',auth_views.PasswordChangeView.as_view(template_name='app/passwordchange.html',form_class=ChangePassword,success_url='/passwordchangedone/'),name='passwordchange'),
