...
class HomeView(View):
    def get(self, request):
        ...
        return render(request, 'app/home.html',
        {'topwears':topwears, 'bottomwears':bottomwears, 'mobiles':mobiles,'laptop':laptop})
...
class CustomerRegistrationView(View): 
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            messages.success(request,f'WELLCOME {username} REGISTRATION SUCCESSFULLY !!!')
            form.save()
        return render(request,'app/customerregistration.html',{'form':form})
...
def checkout(request):
    ...
    if cart_product: 
        for p in cart_product:
            ...
            amount += tempamount
        total_amount=amount+shipping_amount  
    return render(request, 'app/checkout.html',{'add':add,'totalamount':total_amount,'cartitems':cart_items})
